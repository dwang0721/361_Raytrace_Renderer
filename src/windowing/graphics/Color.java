...
public class Color {
	...
	//
	public int asARGB() {
		int alpha = MAX_CHANNEL_INT_VALUE << ALPHA_SHIFT; // 24
		int intR  = integerChannel(r) << RED_SHIFT;  // 16
		int intG  = integerChannel(g) << GREEN_SHIFT; // 8
		int intB  = integerChannel(b) << BLUE_SHIFT; // 0
